...
if __name__ == "__main__":
    ...
    for k in range(NUM_TESTS):
        ...
        # Perform inference using fc6 accelerator
        fc6_inst.write(0x10, conv5_output.ctypes.data)
        fc6_inst.write(0x14, fc6_output.ctypes.data)

        # Trigger the fc6 accelerator
        fc6_inst.write(0x00, 1)

        # Wait for the accelerator to finish
        while fc6_inst.read(0x00) == 0x1:
            pass
